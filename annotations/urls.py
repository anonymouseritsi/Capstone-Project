...
urlpatterns = [
    ...
    path('patients-gallery/<str:name>/', views.patient_details_gallery, name='patient_details_gallery'),
    path('patients-gallery-annotated/<str:name>/', views.patient_details_gallery_annotated, name='patient_details_gallery_annotated'),
